...
- **The Method:**
- _Batch:_ PI Integrator writes [[Parquet\|Parquet]]/[[CSV\|CSV]] files directly to an S3 Bucket (The "Landing Zone" or "[[03-DATABANKS/Atoms/Medallion Architecture Layer - Bronze\|Bronze Layer]]").
...
- **The Location:** **Amazon S3** (The "[[03-DATABANKS/Atoms/Medallion Architecture Layer - Silver\|Silver]]" or "[[03-DATABANKS/Atoms/Medallion Architecture Layer - Gold 1\|Gold]]" Layer).
