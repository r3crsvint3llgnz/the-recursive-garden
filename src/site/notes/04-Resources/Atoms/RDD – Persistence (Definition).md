...
- **Definition:** The measure of a [[04-Resources/Atoms/RDD – Distinction (Definition)\|distinction's]] structural stability across recursive updates. It is the effective resistance to [[04-Resources/Atoms/RDD – Entropy (Definition)\|entropy]].

- **Formalism:** $\Pi(\mathcal{D}) \iff R(\mathcal{D}_t) \approx \mathcal{D}_{t+1}$. Persistence is achieved when the output of recursion is structurally isomorphic to the input.
...
- In a system of constant [[04-Resources/Atoms/RDD – Recursion (Definition)\|recursion]], nothing is static; things only appear solid because they actively rebuild themselves in the same shape every moment.
- It is the result of [[04-Resources/Atoms/RDD – Gravity (Definition)\|Gravity]]: when a distinction falls into a stable loop (eigenbehavior), it resists dissolution and becomes an "object" rather than an "event."
...
- Related atoms: [[04-Resources/Atoms/RDD – Gravity (Definition)\|RDD – Gravity (Definition)]], [[04-Resources/Atoms/RDD – Entropy (Definition)\|RDD – Entropy (Definition)]], [[04-Resources/Atoms/RDD – Existence (Definition)\|RDD – Existence (Definition)]]
