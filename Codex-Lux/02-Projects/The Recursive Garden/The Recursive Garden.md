...
dg-content-classes: home-hero
dg-metatags:
  description: "A live digital garden exploring Recursive Distinction Dynamics, AI practice, and experimental fiction."
  "og:title": "The Recursive Garden"
  # Update this if/when you add a real hero image:
  "og:image": "https://therecursivegarden.netlify.app/_assets/recursive-garden-hero.png"
---
![[therecursivegarden.png]]
...
> ```dataview
> TABLE WITHOUT ID "<img src='" + cover + "' height='80' style='border-radius:6px;object-fit:cover'/>" AS "", file.link AS "Area", summary AS "What lives here"
> FROM ""
> WHERE section = "hubs"
> SORT priority ASC
> ```
